...
\newcommand{\abs}[3]{\lambda #1\mathord{:}#2.#3}
\newcommand{\absP}[3]{(\abs{#1}{#2}{#3})}
\newcommand{\app}[2]{#1\ #2}
...
\newcommand{\arrowP}[2]{(\arrow{#1}{#2})}

\newcommand{\typing}[3]{#1\vdash#2:#3}
\newcommand{\typingG}[2]{\typing{\Gamma}{#1}{#2}}

% \newcommand{\typingi}[3]{#1\mathrel{\hat{\vdash}}#2:#3}
\newcommand{\typingi}[3]{\typing{#1}{#2}{#3}}
\newcommand{\typingiG}[2]{\typingi{\Gamma}{#1}{#2}}
...
\newcommand{\typofityp}[1]{\lvert#1\rvert}
\newcommand{\typofitypn}[1]{\lfloor #1 \rfloor}
\newcommand{\itypoftyp}[1]{\lceil#1\rceil}
%\newcommand{\trmofitrm}[1]{\llbracket#1\rrbracket}
\newcommand{\trmofitrm}[1]{\lvert#1\rvert}
%\newcommand{\ctxofictx}[1]{\llbracket#1\rrbracket}
\newcommand{\ctxofictx}[1]{\lvert#1\rvert}
% \newcommand{\trmofetrm}[1]{\llparenthesis#1\rrparenthesis}
%\newcommand{\trmofetrm}[1]{\llbracket#1\rrbracket}
\newcommand{\trmofetrm}[1]{\lvert#1\rvert}
% \newcommand{\trmofetrm}[1]{#1}
...
\newcommand{\lambdanull}{\lambda_\texttt{null}}
\newcommand{\lambdanulls}{\lambda_\texttt{null}^s}

\newcommand{\safeapp}[3]{\textit{app}(#1,#2,#3)}
