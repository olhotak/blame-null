...
\newcommand{\case}[4]{\code{case}\ #1\ \code{of}\ \lbrace\code{null}\mapsto#2; #3\mapsto#4\rbrace}
...
\newcommand{\subtyppos}[2]{#1 <:_+ #2}
\newcommand{\subtypneg}[2]{#1 <:_- #2}
