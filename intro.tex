...
Null pointers are infamous for causing software errors, with Tony
Hoare characterising them as ``The Billion Dollar Bug''.

Programming language design suggests a way to tame the danger
posed by null.  Whereas older languages, such as C and Java,
permit nulls anywhere, more recent designs, including Kotlin,
Scala, C\#, and Swift, adopt type systems that track whether
a reference may be null.  One question that arises is how to
permit code in the older and newer languages to interact while
preserving the type guarantees of the new languages.
