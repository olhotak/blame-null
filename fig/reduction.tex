\begin{figure}
\infax[App]
{\red{\app{\absP{x}{A}{N}}V}{\subst{N}{x}{V}}}
...
\begin{align*}
    \mathcal{E} \Coloneqq \quad & [] \p \app{\mathcal{E}}{N} \p \app{V}{\mathcal{E}} \p \cast{\mathcal{E}}{A}{p}{B} \p \case{\mathcal{E}}{M}{x}{L} \\
    \p & \lift{\mathcal{E}} \p \binop{\mathcal{E}}{M} \p \binop{V}{\mathcal{E}}
\end{align*}
  \caption{Reduction rules of the explicit language}\label{fig:reduction}
\end{figure}
