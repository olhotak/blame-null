...
Later, in \Cref{sec:impdefn}, we will extend this explicit language with an
implicit language that does not track the possibility of null references in types,
to study the interaction of the two languages.
