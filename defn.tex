\section{The Simple Null Blame Calculus\label{sec:defn}}
In this section, we introduce \TODO{Find a good name for this calculus and the two calculi in section 4.}
a core calculus for a language that tracks nullability in types.
...
Later, in \Cref{sec:impdefn}, we will extend this calculus with additional
terms that model a language in which null references are implicit, not tracked in the
type system, to study the interaction of the two sublanguages.

The syntax of the calculus is shown in \Cref{fig:syntax}. The basic values
...
The typing rules of the calculus are shown in \Cref{fig:typing}.
...
any type $A$. \TODO{Consider removing the Blame rule.} The \rn{Cast} rule allows casts from type $A$ to type $B$ as
...
The operational semantics of the calculus is shown in \Cref{fig:reduction}.
