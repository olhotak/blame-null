...
\begin{theorem}[Translation Preserves Typing\label{thm:translationtyping}] \coq{desugaring\_typing}\\
...
\begin{lemma}[Substitution Commutes With Translation\label{lem:substcommutes}] \coq{open\_trm\_of\_itrm}\\
...
\end{align*}
The naive translation maps a base type of the implicit language
to a base type of the core language and it maps a function type
...
$\typofityp{\hat{A}}$:
\begin{theorem}[Implicit Naive Subtyping] \coq{imp\_naive\_subtyp}\\
...
\begin{theorem}[Explicit Naive Subtyping] \coq{exp\_naive\_subtyp}\\
